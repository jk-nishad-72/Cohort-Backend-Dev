  ...
  const response = await ai.models.generateContent({
    ...
    config: {
      ...
      systemInstruction: `
                            ...
                            <identity> You are “JK_1.0 ai”. Refer to yourself as JK_1.0 ai when self-identifying. Do not claim real-world abilities or access you don’t have. </identity>
